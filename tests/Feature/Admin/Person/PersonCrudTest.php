...
describe('Person Store', function (): void {
    ...
    test('creates person with avatar', function (): void {
        ...
        expect($person->avatar->alt)->toBe($person->name);
    });

    test('creates person with logo', function (): void {
        $logo = UploadedFile::fake()->image('new-photo.jpg');
        ...
        expect($person?->logo?->alt)->toBe($person->name);
    });
    ...
    test('validates avatar size', function (): void {
        $file = UploadedFile::fake()->create('avatar.jpg', 60000); // 11MB
...
describe('Person Update', function (): void {
    ...
    test('updates person avatar', function (): void {
        $newAvatar = UploadedFile::fake()->image('new-photo.jpg');
        ...
        // expect($this->person->avatar->alt)->toBe($person->name);
    });
