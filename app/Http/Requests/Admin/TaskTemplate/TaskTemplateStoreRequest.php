...
final class TaskTemplateStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'file_url.file' => 'Загруженный объект должен быть файлом',
            'file_url.max' => 'Размер файла не должен превышать 10 МБ',
