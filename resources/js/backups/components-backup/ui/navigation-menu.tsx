...
function NavigationMenuLink({
    ...
    return (
        <NavigationMenuPrimitive.Link
            ...
            className={cn(
                "hover:text-accent-foreground focus-visible:text-accent-foreground data-[active=true]:text-accent-foreground ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 flex flex-col gap-1 rounded-sm p-2 text-sm transition-[color,box-shadow] hover:bg-accent focus-visible:bg-accent focus-visible:ring-4 focus-visible:outline-1 data-[active=true]:bg-accent/50 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
                className,
            )}
            {...props}
        />
