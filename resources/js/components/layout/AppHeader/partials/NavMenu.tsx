...
const NavMenu: FC<NodeProps> = ({ className }) => {
    ...
    return (
        <div
            className={cn(
                'px-7.5 duration-300 ease-in-out sm:pb-8 sm:transition-all lg:fixed lg:top-24 lg:left-10 lg:z-10 lg:rounded-xl lg:border lg:border-gray-200/40 lg:bg-white lg:shadow-xl xl:top-36.5 xl:left-31',
                {
